...
android {
    namespace = "com.pushgate.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.pushgate.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 2
        versionName = "1.1.0"
    ...
    signingConfigs {
        create("release") {
            // Populated from env vars in CI; falls back to the debug key locally so
    ...
    packaging {
        ...
        // The pose model must stay uncompressed so MediaPipe can mmap it.
